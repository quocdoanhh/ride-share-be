...
class DemoDecoratorCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'demo:decorator {--type=all : Demo type (all, upgrade, custom)} {--name= : Custom user name} {--email= : Custom user email} {--roles=* : Custom user roles}';
    ...
    public function handle()
    {
        ...
        $this->line('Để tạo user tùy chỉnh, sử dụng:');
        $this->line('php artisan demo:decorator --type=custom --name="Nguyễn Văn A" --roles=driver --roles=premium');
    }
